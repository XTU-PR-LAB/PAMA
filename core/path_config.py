...
H36M_ROOT = join('/path/datasets/', 'Datasets/h36m')  #加.
LSP_ROOT = join('/path/datasets/', 'Datasets/human/LSP/lsp_dataset_small')
LSP_ORIGINAL_ROOT = join('/path/datasets/', 'Datasets/LSP/lsp_dataset_original')
LSPET_ROOT = join('/path/datasets/', 'Datasets/LSP/hr-lspet')
MPII_ROOT = join('/path/datasets/', 'Datasets/mpii')
COCO_ROOT = join('/path/datasets/', 'Datasets/coco')
MPI_INF_3DHP_ROOT = join('/path/datasets/',
                         'Datasets/mpi_inf_3dhp_train_set')
PW3D_ROOT = join('/path/datasets/', 'Datasets/3DPW')
UPI_S1H_ROOT = join('/path/datasets/', 'Datasets/human/upi-s1h')
SURREAL_ROOT = join('/path/datasets/', 'Datasets/human/SURREAL/data')
threeDOH50K_ROOT = join('/path/datasets/', 'Datasets/human/3DOH50K')
