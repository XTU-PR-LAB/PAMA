...
class TrainOptions():
    def __init__(self):
        ...
        train.add_argument('--regressor', type=str, choices=['hmr', 'knowledge_net'], default='knowledge_net', help='Name of the SMPL regressor.')
        train.add_argument('--cfg_file', type=str, default='./configs/config.yaml', help='config file path for network.')
        ...
        # train.add_argument('--single_dataset', default=True, action='store_true', help='Use a single dataset')
        ...
        '''train.add_argument('--world_size', default=os.environ['WORLD_SIZE'], type=int,
                    help='number of nodes for distributed training')'''
        train.add_argument("--local_rank", default=0, type=int)
        '''train.add_argument("--local_rank", default=os.environ['LOCAL_RANK'], type=int)'''
        ...
        train.add_argument('--ALB', default=True, action='store_true', help='augmentation parameter')
        train.add_argument('--ALB_PROB', type=float, default=0.3, help='augmentation parameter')
        return
